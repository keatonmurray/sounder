    ...
    <section id="profileSettingsArea" class="py-2" style="height: auto; background: #f5f9fa;">
        <div class="container my-4">
            <x-form.body>
                ...
                <br>
                @if($profile)
                    <form action="/update-new-fan-profile/{{$profile->id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                ...
                @else 
                <form action="/save-fan-profile" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <x-form.border>
