    ...
    <section id="profileSettingsArea" class="py-2" style="height: auto; background: #f5f9fa;">
        <div class="container my-4">
            <x-form.body>
                ...
                <br>
                @if($profile)
                    <form action="/update-new-artist-profile/{{$profile->id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <x-form.border>
                                    ...
                                    <h6>Profile Picture</h6>
                                        ...
                                        <img src="{{$profile->profile_picture ? asset('storage/' . $profile->profile_picture) : asset('assets/img/bg-img/gallery.svg')}}" class="artist-profile-photo" style="height: 200px; width: 200px;">
                                        </x-form.thumbnail>
                            ...
                            <div class="col-12 col-sm-6">
                                <x-form.border>
                                    ...
                                    <h6>Cover Photo</h6>
                                        <x-form.thumbnail type="mt-3 mb-2">
                                        <img src="{{$profile->cover_photo ? asset('storage/' . $profile->cover_photo) : asset('assets/img/bg-img/gallery.svg')}}" class="artist-cover-photo" style="height: 200px; width: 200px;">
                                        </x-form.thumbnail>
                    ...
                    @else 
                    <form action="/save-artist-profile" method="POST" enctype="multipart/form-data">
                        @csrf
                        <h6 class="text-center mb-4">Add a Profile and Cover Photo</h6>
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <x-form.border>
                                    <div class="text-center mb-4 mx-2">
